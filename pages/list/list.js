...
Page({
  ...
  addNumber: function (e) {
    ...
    var sum =app.accAdd(this.data.sumMonney , cartList[index].price);
    // var sum = this.data.sumMonney + cartList[index].price;
    // cartList[index].sum += cartList[index].price;
    cartList[index].sum = app.accAdd(cartList[index].sum, cartList[index].price);
    this.setData({
      listData: listData,
      cartList: cartList,
      sumMonney: sum,
  ...
  decNumber: function (e) {
    ...
    var listData = this.data.listData
    listData[cartList[index].cType].foods[cartList[index].cIndex].num = listData[cartList[index].cType].foods[cartList[index].cIndex].num - 1
    var sum = app.accSubtr(this.data.sumMonney, cartList[index].price);
    // var sum = this.data.sumMonney - cartList[index].price;
    // cartList[index].sum -= cartList[index].price;
    cartList[index].sum = app.accSubtr(cartList[index].sum, cartList[index].price);
